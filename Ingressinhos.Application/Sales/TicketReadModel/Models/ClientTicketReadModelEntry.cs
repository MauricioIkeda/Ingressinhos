namespace Ingressinhos.Application.Sales.TicketReadModel.Models;

public class ClientTicketReadModelEntry // DTO, mas interno, usado ler  escreve o modelo de leitura
{
